 ...
 */
export const typescriptTargetSchema = z
  .object({
 ...
 */
export const contractMappingSchema = z
  .object({
...
export const riskConfigSchema = z
  .object({
    ...
    productionPatterns: z
      .array(z.string().min(1, 'Production pattern must not be empty'))
      .optional(),
  })
  .strict();
 ...
 */
export const devGuardConfigSchema = z
  .object({
    version: z.literal(1, {
